...
LoadModule proxy_http_module /usr/lib64/apache2-prefork/mod_proxy_http.so' > ap9-system2/extra-proxy.conf

echo 'ProxyPreserveHost On
ProxyPass / http://127.0.0.1:3190/
ProxyPassReverse / http://127.0.0.1:3190/' > ap9-system2/dir.conf
#####################################
