...
for x in $ap7 $ap8 $ap9 $mc1 $mc2; do
    ...
    echo 111113 > $x/dt/folder1/file2.1-Current.iso.zsync
    ( cd $x/dt/folder1 && ln -s file2.1-Current.iso.zsync file-Current.iso.zsync )
...
$mc2/curl -H 'Accept: Application/x-zsync' -IL /download/folder1/file-Current.iso.zsync    | grep '404 Not Found'
$mc2/curl -H 'Accept: Application/x-zsync' -I  /download/folder1/file2.1-Current.iso.zsync | grep '404 Not Found' # we don't have zhashes for this file
$mc2/curl -H 'Accept: Application/x-zsync' -I  /download/folder1/file2.1-Current.iso | grep '404 Not Found' # we don't have zhashes for this file
$mc2/curl -H 'Accept: Application/metalink+xml' -I /download/folder1/file2.1-Current.iso | grep '200 OK'
$mc2/curl -H 'Accept: Application/metalink+xml, */*' -I /download/folder1/file2.1-Current.iso | grep '200 OK'
$mc2/curl -H 'Accept: Application/metalink+xml, */*' -I /download/folder1/file-Current.iso.zsync | grep --color=never -P '/download/folder1/file2.1-Current.iso.zsync\r$'

$mc2/curl -I /download/folder1/file-Current.iso.zsync | grep --color=never -P '/download/folder1/file2.1-Current.iso.zsync\r$'
