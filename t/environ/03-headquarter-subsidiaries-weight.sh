...
$mc9/db/sql "insert into subsidiary(hostname,region,weight) select '$na_address1','na',1"
$mc9/db/sql "insert into subsidiary(hostname,region,weight) select '$na_address2','na',3"
