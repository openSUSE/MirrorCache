...
for i in 9 6; do
    test b2c5860a03d2c4f1f049a3b2409b39a8 == $(mc$i/sql 'select md5 from hash where file_id=2')
    test 5179db3d4263c9cb4ecf0edbc653ca460e3678b7 == $(mc$i/sql 'select sha1 from hash where file_id=2')
    test 63d19a99ef7db94ddbb1e4a5083062226551cd8197312e3aa0aa7c369ac3e458 == $(mc$i/sql 'select sha256 from hash where file_id=2')
    test 5179db3d4263c9cb4ecf0edbc653ca460e3678b7 == $(mc$i/sql 'select pieces from hash where file_id=2')
    test 2a276e680779492af2ed54ba5661ac5f35b39e363c95a55ddfac644c1aca2c3f68333225362e66536460999a7f86b1f2dc7e8ef469e3dc5042ad07d491f13de2 == $(mc$i/sql 'select sha512 from hash where file_id=2')
done
...
test d8f5889697e9ec5ba9a8ab4aede6e7d1d7858884e81db19b3e9780d6a64671a3 == $(mc9/sql 'select sha256 from hash where file_id=4')

mc6/backstage/job -e folder_sync -a '["/folder2"]'
mc6/backstage/shoot
mc6/backstage/shoot -q hashes

test d8f5889697e9ec5ba9a8ab4aede6e7d1d7858884e81db19b3e9780d6a64671a3 == $(mc6/sql 'select sha256 from hash where file_id=4')
...
mc9/backstage/shoot
mc9/backstage/shoot -q hashes
test e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855 == $(mc9/sql 'select sha256 from hash where file_id=6')

sleep $DELAY
mc6/backstage/shoot -q hashes
test e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855 == $(mc6/sql 'select sha256 from hash where file_id=6')
...
test e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855 == $(mc9/sql 'select sha256 from hash where file_id=9')
...
test e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855 == $(mc9/sql 'select sha256 from hash where file_id=8')
test                                                                  -z "$(mc9/sql 'select sha256 from hash where file_id=9')"
...
test e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855 == $(mc9/sql 'select sha256 from hash where file_id=8')
test e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855 == $(mc6/sql 'select sha256 from hash where file_id=9')
...
mc9/curl -I /link1/child1/child1.1.dat | grep -E "$($ap1/print_address)|$($ap2/print_address)"
...
mc6/sql_test /link1/child1 == "select path from folder where path = '/link1/child1'"

mc6/sql_test 0 -lt "select count(*) from folder_diff join folder on folder_id = folder.id where path ='/link1/child1'"

mc6/curl -I /link1/child1/child1.1.dat | grep -E "$($ap4/print_address)|$($ap3/print_address)"
