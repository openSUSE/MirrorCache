...
$mc/sql_test 1 == "select count(*) from minion_jobs where task = 'mirror_scan' and args like '%/folder1%'" || \
  $mc/sql_test 1 == "select count(*) from minion_jobs where task = 'mirror_scan' and args::varchar like '%/folder1%'"
...
$mc/sql_test 2 == "select count(*) from minion_jobs where task = 'mirror_scan' and args like '%/folder1%'" || \
  $mc/sql_test 2 == "select count(*) from minion_jobs where task = 'mirror_scan' and args::varchar like '%/folder1%'"
