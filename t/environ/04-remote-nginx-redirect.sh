...
$mc/db/sql "insert into server(hostname,urldir,enabled,country,region) select '$($ng7/print_address)','',1,'us','na'"
$mc/db/sql "insert into server(hostname,hostname_vpn,urldir,enabled,country,region) select 'non-vpn.us','$($ng8/print_address)','',1,'us','na'"
