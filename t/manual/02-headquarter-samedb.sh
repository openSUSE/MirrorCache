...
declare -A xtra
xtra[$hq]=''
xtra[$eu]=MIRRORCACHE_REGION=eu
xtra[$na]=MIRRORCACHE_REGION=na
xtra[$oc]=MIRRORCACHE_REGION=oc
...
$hq/sql "delete from server where region = 'oc'"
...
$oc/sql "delete from server where region != 'oc'"
